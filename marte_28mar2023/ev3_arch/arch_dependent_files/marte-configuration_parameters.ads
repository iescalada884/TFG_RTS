...
--
--
--  This is the EV3 architecture version of this package.
--
--
--
...
package MaRTE.Configuration_Parameters is
   ...
   type Supported_Architectures is (ARCH_X86, ARCH_LINUX, ARCH_LINUX_LIB,
                                    ARCH_XTRATUM, ARCH_RPI, ARCH_GNAT_BB_ARM,
                                    ARCH_STM32F, ARCH_EV3);
   subtype MaRTE_Architecture is Supported_Architectures
     range ARCH_EV3 .. ARCH_EV3; --  DO NOT EDIT !!
   ...
   Main_Stack_Size_In_Bytes : constant := 4 * 1024;
   --  _DEFAULT_STACK_SIZE = 4*1024;
   --  Defined in arm-eabi/lib/gnat/zfp-stm32f4/ld/common-ROM.ld
   ...
   ----------------------------------------------------------------------------
   Use_Application_Defined_Scheduling : constant Boolean := False;
   ...
   Mx_Number_Of_Interrupt_Associations : constant := 10;  --  {PREALLOCATED}
