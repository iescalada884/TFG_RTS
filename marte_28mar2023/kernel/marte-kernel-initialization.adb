...
package body MaRTE.Kernel.Initialization is
   ...
   begin
      ...
      HAL.Initialize;
      pragma Assert (CP.MaRTE_Architecture'First = CP.ARCH_LINUX or else
                     CP.MaRTE_Architecture'First = CP.ARCH_LINUX_LIB or else
      ...
      K.Suspension_Time_Minimum :=
        (CP.Suspension_Time_Minimum *
           HAL.Get_HWClock_Frequency) / HAL.CPU_Frequency;
      ...
      pragma Assert (HAL.Are_Interrupts_Enabled);
