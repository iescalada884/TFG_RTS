...
package body MaRTE.Kernel.File_System is
   ...
   function Write
     ...
     return Int is
      ...
      function To_Address is new Ada.Unchecked_Conversion (Buffer_Ac,
                                                           System.Address);

   begin
      if not CP.Use_Devices_Filesystem then
         Direct_IO.Direct_Write_On_Stdout
           (To_Address (Buffer_Ptr), Integer_Types.Size_T (Bytes_To_Write));
