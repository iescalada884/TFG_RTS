...
package body MaRTE.Kernel.Condition_Variables is
   ...
   function Pthread_Cond_Init (Cond : not null access Condition;
   ...
   --------------------------
   function Pthread_Cond_Destroy (Cond : not null access Condition)
                                  return Int is
      Flags : Integer;
   begin
   ...
   -- Pthread_Cond_Signal --
   -------------------------
   function Pthread_Cond_Signal (Cond : not null access Condition)
                                return Int is
      Flags : Integer;
      T_Mx_Prio : Task_Id;
   begin
