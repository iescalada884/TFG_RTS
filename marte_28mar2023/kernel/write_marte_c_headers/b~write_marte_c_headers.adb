pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~write_marte_c_headers.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~write_marte_c_headers.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_write_marte_c_headers");
...
--  BEGIN Object file/option list
   --   ./marte.o
   --   ./marte-configuration_parameters.o
   --   ./marte-debug_messages.o
   --   ./marte-integer_types.o
   --   ./marte-posix_constants.o
   --   ./marte-error_codes_info.o
   --   ./general_constants_info.o
   --   ./kernel_types_sizes.o
   --   ./signals_info.o
   --   ./write_marte_c_headers.o
   --   -L./
   --   -L/home/ubuntfg/opt/GNAT/2020/lib/gcc/x86_64-pc-linux-gnu/9.3.1/adalib/
   --   -static
   --   -lgnat
   --   -ldl
