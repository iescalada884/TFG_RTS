...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_write_marte_c_headers" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ce978b84#;
   pragma Export (C, u00001, "write_marte_c_headersB");
   ...
   u00135 : constant Version_32 := 16#2dfce3af#;
   pragma Export (C, u00135, "system__val_unsS");
   u00136 : constant Version_32 := 16#f08789ae#;
   pragma Export (C, u00136, "ada__text_io__enumeration_auxB");
   u00137 : constant Version_32 := 16#c468c016#;
   pragma Export (C, u00137, "ada__text_io__enumeration_auxS");
   u00138 : constant Version_32 := 16#2bcf5f92#;
   pragma Export (C, u00138, "general_constants_infoS");
   u00139 : constant Version_32 := 16#99bc4a3f#;
   pragma Export (C, u00139, "marteS");
   u00140 : constant Version_32 := 16#3a76628c#;
   pragma Export (C, u00140, "marte__posix_constantsS");
   u00141 : constant Version_32 := 16#7118d9fd#;
   pragma Export (C, u00141, "marte__integer_typesS");
   u00142 : constant Version_32 := 16#c28deb15#;
   pragma Export (C, u00142, "kernel_types_sizesS");
   u00143 : constant Version_32 := 16#a1a2e31e#;
   pragma Export (C, u00143, "marte__configuration_parametersS");
   u00144 : constant Version_32 := 16#b6e188cf#;
   pragma Export (C, u00144, "marte__debug_messagesS");
   u00145 : constant Version_32 := 16#d5fc363a#;
   pragma Export (C, u00145, "marte__error_codes_infoS");
   u00146 : constant Version_32 := 16#abf14b59#;
   pragma Export (C, u00146, "signals_infoS");
   ...
   u00150 : constant Version_32 := 16#4d45b0a1#;
   ...
   u00153 : constant Version_32 := 16#b31a5821#;
   pragma Export (C, u00153, "system__img_enum_newB");
   u00154 : constant Version_32 := 16#2779eac4#;
   ...
   u00156 : constant Version_32 := 16#243407ff#;
   pragma Export (C, u00156, "system__val_enumS");
   u00157 : constant Version_32 := 16#8f461df5#;
   ...
   --  marte.error_codes_info%s
   --  general_constants_info%s
   --  kernel_types_sizes%s
   --  signals_info%s
   --  write_marte_c_headers%b
