...
package MaRTE.Debug_Messages is
   ...
   subtype Enter_Kernel_Messages is Boolean range False .. False;
   --  Enable or disable the Enter/Leave Kernel messages.
   ...
   subtype Stacks_Management_Messages is Boolean range False .. False;
   --  Enable or disable the messages related to the management of the tasks'
   --  stacks.
   ...
   Tasks_Inspector_Log_Device : constant Log_Device := LOG_DISK;
