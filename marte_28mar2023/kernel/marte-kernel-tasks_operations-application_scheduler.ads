...
package MaRTE.Kernel.Tasks_Operations.Application_Scheduler is
   ...
   function POSIX_Appsched_Actions_Addtimedactivation
       (Sched_Actions : access APPSCHD_DATA.Sched_Actions_Set;
        ...
        At_Time       : in     Timespec.Timespec_Ac_Const) return Int;
   pragma Export (C, POSIX_Appsched_Actions_Addtimedactivation,
   ...
   function POSIX_Appsched_Actions_Addthreadnotification
       (Sched_Actions : access APPSCHD_DATA.Sched_Actions_Set;
        T             : in     K.Task_Id;
        At_Time       : in     Timespec.Timespec_Ac_Const) return Int;
   pragma Export (C, POSIX_Appsched_Actions_Addthreadnotification,
                  "posix_appsched_actions_addthreadnotification");
   pragma Inline (POSIX_Appsched_Actions_Addthreadnotification);
