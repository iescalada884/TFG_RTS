...
package body MaRTE.Kernel.Tasks_Operations.Application_Scheduler is
   ...
   function POSIX_Appsched_Actions_Addtimedactivation
       (Sched_Actions : access APPSCHD_DATA.Sched_Actions_Set;
        ...
        At_Time       : in     Timespec.Timespec_Ac_Const) return Int is
   begin
      if not CP.Use_Application_Defined_Scheduling then
         return OPERATION_NOT_IMPLEMENTED;
      end if;
      ...
      Sched_Actions.Set (Sched_Actions.Last).At_Time :=
        Timespec.Timespec_To_HWTime (At_Time.all);
      return 0;
   end POSIX_Appsched_Actions_Addtimedactivation;

   ---------------------------------------------------
   -- POSIX_Appsched_Actions_Addthreadknotification --
   ---------------------------------------------------
   function POSIX_Appsched_Actions_Addthreadnotification
     (Sched_Actions : access APPSCHD_DATA.Sched_Actions_Set;
      T             : in     K.Task_Id;
      At_Time       : in     Timespec.Timespec_Ac_Const) return Int is
   begin
      ...
      Sched_Actions.Set (Sched_Actions.Last).At_Time :=
        Timespec.Timespec_To_HWTime (At_Time.all);
      return 0;
   end POSIX_Appsched_Actions_Addthreadnotification;
   ...
   begin
      ...
      SCHD.Do_Scheduling;
      -- Give chance to the scheduler task to execute
      SCHD.Context_Switch_Window;
