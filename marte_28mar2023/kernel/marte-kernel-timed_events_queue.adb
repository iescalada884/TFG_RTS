...
package body MaRTE.Kernel.Timed_Events_Queue is
   ...
   begin
      ...
      Q (Q_Size) := E;
      UpHeap (Q_Size);
      pragma Debug (Show_TEQ_On_Console ("Enq_Event_EQ:"));
   ...
   begin
      ...
      Q_Size := Q_Size - 1;
      DownHeap (1, Q_Size);
      pragma Debug (Show_TEQ_On_Console ("RM_head_EQ:"));
      return E;
   end Remove_Head;
   ...
   begin
      ...
      while I < Q_Size loop
         ...
         if E = Q (I) then
            ...
            Q_Size := Q_Size - 1;
            DownHeap (I, Q_Size);
            pragma Debug (Show_TEQ_On_Console ("RM_EQ:"));
            return;
         end if;
      end loop;
   ...
   begin
      pragma Assert (Initialized);
      pragma Debug (Show_TEQ_On_Console ("Head?_EQ:"));
      if Q_Size = 0 then
         return null;
      else
         return Q (1);
