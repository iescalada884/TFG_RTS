...
package MaRTE.POSIX_Time is
   ...
   function Time (Tloc : in Int_Ac)
                 return MaRTE.Integer_Types.Int;
#if DEF_MARTE_ARCH = "Linux_Lib" then
   pragma Export (C, Gettimeofday, "marte_gettimeofday");
   --  In "linux_lib" we want to use the standard function provided by Linux.
   pragma Export (C, Time, "marte_time");

#elsif DEF_MARTE_ARCH = "RPI" or DEF_MARTE_ARCH = "STM32F" or DEF_MARTE_ARCH = "GNAT_BB_ARM" or DEF_MARTE_ARCH = "X86" or DEF_MARTE_ARCH = "Linux" or DEF_MARTE_ARCH = "ev3" then
   pragma Export (C, Time, "time");
...
#elsif DEF_MARTE_ARCH = "RPI" or DEF_MARTE_ARCH = "STM32F" or DEF_MARTE_ARCH = "GNAT_BB_ARM" or DEF_MARTE_ARCH = "X86" or DEF_MARTE_ARCH = "Linux" or DEF_MARTE_ARCH = "ev3" then
   pragma Export (C, Gettimeofday, "gettimeofday");
