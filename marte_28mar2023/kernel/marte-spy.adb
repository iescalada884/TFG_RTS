...
package body MaRTE.Spy is
   ...
   Last_Timestamp : HAL.HWTime := 0;

   function Timestamp_OK (Timestamp : HAL.HWTime) return Boolean is
      use type HAL.HWTime;
      OK : Boolean;
   begin
      OK := Timestamp >= Last_Timestamp;
   ...
   begin
      ...
      Spy_Send_Event_One_Object
        (0, 'C', 'F',
         Int (HAL.Get_HWClock_Frequency/10), 0);

      --     #init_timestamp#TR(0,Prio_Of_Main)#

      Last_Timestamp := HAL.Get_HWTime_Slow;
   ...
   begin
      ...
      pragma Assert (Timestamp_OK (Timestamp));
   ...
   begin
      ...
      Send_Event (Timestamp, Operation, Id, Integer (Prio));
   end Send_Event;
   ...
   -------------------------------
   -- Send_Event_If_Initialized --
   -------------------------------

   procedure Send_Event_If_Initialized (Operation : in String;
                                        Param1    : in Integer;
                                        Param2    : in Integer) is
   begin
      ...
      Send_Event (HAL.Get_HWTime, Operation, Param1, Param2);
   end Send_Event_If_Initialized;
