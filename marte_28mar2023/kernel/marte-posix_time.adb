...
package body MaRTE.POSIX_Time is
   ...
   begin
      return Itimerspec'
        (It_Value    => Timespec.HWTime_To_Timespec (TS.Initial),
         It_Interval => Timespec.HWTime_To_Timespec (TS.Interval));
   end To_Itimerspec;
   ...
   begin
      return Timers.Timer_State'
        (Initial  => Timespec.Timespec_To_HWTime (ITS.It_Value),
         Interval => Timespec.Timespec_To_HWTime (ITS.It_Interval));
   end To_Timer_State;
