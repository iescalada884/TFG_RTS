--  MaRTE OS: this is a melding of two versions of this file:
--  the one provided by GPL-2016 (rts-sjlj) and the one provided by
--  GPL-2014 for 32bits.
--  This file keeps the GPL2016 structure but sets some constants to the
--  value expected in a 32bits architecture (taken from GPL-2014 for
--  32bits).
...
--  This is the version for i686-pc-linux-gnu (MaRTE)
...
package System.OS_Constants is
   ...
   --  MaRTE OS. Should use the same numbers than in marte-posix_constants.ads
   ...
   --  MaRTE OS: SIZEOF_tv_[sec,usec] changed from 8 to 4
   ...
   SIZEOF_sigset           : constant Interfaces.C.size_t;
   pragma Import (C, SIZEOF_sigset, "SIGNAL_SET_SIZE_IN_BYTES");
   --  MaRTE OS >>
   ...
   CLOCK_REALTIME          : constant Integer;
   pragma Import (C, CLOCK_REALTIME,
                  "marte__kernel__timers__clock_realtime");
   CLOCK_MONOTONIC         : constant Integer;
   pragma Import (C, CLOCK_MONOTONIC,
                  "marte__kernel__timers__clock_monotonic");
   CLOCK_THREAD_CPUTIME_ID : constant Integer;
   pragma Import (C, CLOCK_THREAD_CPUTIME_ID,
                  "marte__kernel__timers__clock_thread_cputime_id");
   CLOCK_RT_Ada            : constant Integer;
   pragma Import (C, CLOCK_RT_Ada,
                  "marte__kernel__timers__clock_realtime");
   --  MaRTE OS >>
   ...
   PTHREAD_MUTEX_SIZE            : constant := 140;    --  pthread_mutex_t
   ...
   PTHREAD_ATTR_SIZE       : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_ATTR_SIZE, "PTHREADATTR_SIZE_IN_BYTES");

   PTHREAD_MUTEXATTR_SIZE  : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_MUTEXATTR_SIZE, "MUTEXATTR_SIZE_IN_BYTES");

   PTHREAD_MUTEX_SIZE_MaRTE      : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_MUTEX_SIZE_MaRTE, "MUTEX_SIZE_IN_BYTES");
   pragma Assert (PTHREAD_MUTEX_SIZE = PTHREAD_MUTEX_SIZE_MaRTE);

   PTHREAD_CONDATTR_SIZE   : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_CONDATTR_SIZE, "CVATTR_SIZE_IN_BYTES");

   PTHREAD_COND_SIZE_MaRTE       : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_COND_SIZE_MaRTE, "CV_SIZE_IN_BYTES");
   pragma Assert (PTHREAD_COND_SIZE = PTHREAD_COND_SIZE_MaRTE);

   --  PTHREAD_RWLOCKATTR_SIZE : constant Interfaces.C.int;
   --  pragma Import (C, PTHREAD_RWLOCKATTR_SIZE, "MUTEXATTR_SIZE_IN_BYTES");
   --  No RW lock in MaRTE. Using mutex instead

   --  PTHREAD_RWLOCK_SIZE     : constant Interfaces.C.int;
   --  pragma Import (C, PTHREAD_RWLOCK_SIZE, "MUTEX_SIZE_IN_BYTES");
   --  No RW lock in MaRTE. Using mutex instead

   PTHREAD_ONCE_SIZE       : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_ONCE_SIZE,
