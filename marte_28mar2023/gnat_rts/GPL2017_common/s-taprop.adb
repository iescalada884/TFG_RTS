...
--  with System.Stack_Checking.Operations; MaRTE OS
...
package body System.Task_Primitives.Operations is
   ...
   --  package SC renames System.Stack_Checking.Operations; MaRTE OS
...
--        Param.sched_priority := Interfaces.C.int (Prio) + 1;
      ...
      then  --  EDF only in MaRTE OS
         ...
         begin
            ...
            Param.sched_priority := Interfaces.C.int (Low_Prio);
            Result :=
              pthread_setschedparam
                (T.Common.LL.Thread, SCHED_EDF, Param'Access);
         end;
...
--        pragma Assert (Result = 0 or else Result = ENOMEM);
   ...
   begin
      ...
      --  MaRTE OS
      --  SC.Invalidate_Stack_Cache
      --  (T.Common.Compiler_Data.Pri_Stack_Info'Access);
