...
with System.Traces;
with System.OS_Interface;  --  MaRTE
with Interfaces.C;  --  MaRTE

package body System.Tasking.Entry_Calls is

   package STPO renames System.Task_Primitives.Operations;
   package OSI renames System.OS_Interface;  --  MaRTE
   ...
   is
      Ret : Interfaces.C.int;  --  MaRTE
      use type Interfaces.C.int;  --  MaRTE
   begin
      ...
      Ret :=  --  MaRTE
        OSI.marte_enable_rr_quantum (STPO.Get_Thread_Id (Acceptor));
      pragma Assert (Ret = 0);  --  MaRTE
