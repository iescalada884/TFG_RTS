...
package System.OS_Constants is
   ...
   PTHREAD_MUTEX_SIZE      : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_MUTEX_SIZE, "MUTEX_SIZE_IN_BYTES");

   PTHREAD_CONDATTR_SIZE   : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_CONDATTR_SIZE, "CVATTR_SIZE_IN_BYTES");

   PTHREAD_COND_SIZE       : constant Interfaces.C.size_t;
   pragma Import (C, PTHREAD_COND_SIZE, "CV_SIZE_IN_BYTES");
