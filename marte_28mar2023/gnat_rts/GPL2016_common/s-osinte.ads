...
package System.OS_Interface is
   ...
   pragma Linker_Options ("-lmarte" & ASCII.NUL & "-lgnat"); --  MaRTE
   ...
   --  pragma Import (C, errno, "__get_errno");  --  MaRTE OS
   ...
   --  SIGLTHRRES : constant := System.Linux.SIGLTHRRES; MaRTE (>= 32)
   --  SIGLTHRCAN : constant := System.Linux.SIGLTHRCAN; MaRTE (>= 32)
   --  SIGLTHRDBG : constant := System.Linux.SIGLTHRDBG; MaRTE (>= 32)
   ...
   Unmasked : constant Signal_Set := (
      ...
      SIGKILL, SIGSTOP); -- ,  MaRTE OS
      --  These two signals actually can't be masked (POSIX won't allow it)

--      SIGLTHRRES, SIGLTHRCAN, SIGLTHRDBG);  MaRTE OS
...
--     end record;
   ...
   --  type struct_sigaction_ptr is access all struct_sigaction; MaRTE OS
...
--        oact : struct_sigaction_ptr) return int;
   SA_SIGINFO  : constant int;
   SA_ONSTACK  : constant int := 0;
   SIG_BLOCK   : constant int;
   SIG_UNBLOCK : constant int;
   SIG_SETMASK : constant int;
   pragma Import (C, SA_SIGINFO, "marte__kernel__signals__sa_siginfo");
   pragma Import (C, SIG_BLOCK, "marte__kernel__signals__sig_block");
   pragma Import (C, SIG_UNBLOCK, "marte__kernel__signals__sig_unblock");
   pragma Import (C, SIG_SETMASK, "marte__kernel__signals__sig_setmask");

   SIG_DFL : constant int;
   SIG_IGN : constant int;
   pragma Import (C, SIG_DFL, "marte__kernel__signals__sig_dfl");
   pragma Import (C, SIG_IGN, "marte__kernel__signals__sig_ign");
...
--     --  Maps System.Any_Priority to a POSIX priority
   ...
   SCHED_FIFO  : constant int;
   SCHED_RR    : constant int;
   SCHED_OTHER : constant int;
   SCHED_EDF   : constant int;
   pragma Import (C, SCHED_FIFO, "marte__kernel__sched_fifo");
   pragma Import (C, SCHED_RR, "marte__kernel__sched_rr");
   pragma Import (C, SCHED_OTHER, "marte__kernel__sched_other");
   pragma Import (C, SCHED_EDF, "marte__kernel__sched_edf");
   --  MaRTE OS >>
...
--   type pid_t is private;
   ...
   --  pragma Import (C, getpid, "getpid");  MaRTE OS
   ...
   --  pragma Import (C, prctl); MaRTE OS
...
--   PTHREAD_CREATE_DETACHED : constant := 1;
   ...
   PTHREAD_CREATE_DETACHED : constant int;
   pragma Import (C, PTHREAD_CREATE_DETACHED,
                    "marte__kernel__pthread_create_detached");
   --  MaRTE OS >>
...
--     --  This must be in keeping with init.c:__gnat_alternate_stack
   ...
   --  MaRTE OS: No alternate signal stack is used on this platform
   --  MaRTE OS >>
   ...
   --  This is a dummy procedure to share some GNULLI files (not in MaRTE OS)
   ...
   function pthread_sigmask
     (how  : int;
      set  : access constant sigset_t;  --  MaRTE OS: added constant
   ...
   --  MaRTE OS: not RW lock in MaRTE, mutex is used instead but the
...
--   pragma Import (C, pthread_rwlockattr_init, "pthread_rwlockattr_init");
   pragma Import (C, pthread_rwlockattr_init, "pthread_mutexattr_init");

   function pthread_rwlockattr_destroy
     (attr : access pthread_rwlockattr_t) return int;
--  MaRTE
--  pragma
--    Import (C, pthread_rwlockattr_destroy, "pthread_rwlockattr_destroy");
   pragma Import (C, pthread_rwlockattr_destroy, "pthread_mutexattr_destroy");
...
--   pragma Import (C, pthread_rwlock_init, "pthread_rwlock_init");
   pragma Import (C, pthread_rwlock_init, "pthread_mutex_init");
...
--   pragma Import (C, pthread_rwlock_destroy, "pthread_rwlock_destroy");
   pragma Import (C, pthread_rwlock_destroy, "pthread_mutex_destroy");

   function pthread_rwlock_rdlock (mutex : access pthread_rwlock_t)
                                  return int;
--  MaRTE
--   pragma Import (C, pthread_rwlock_rdlock, "pthread_rwlock_rdlock");
   pragma Import (C, pthread_rwlock_rdlock, "pthread_mutex_lock");

   function pthread_rwlock_wrlock (mutex : access pthread_rwlock_t)
                                  return int;
--  MaRTE
--   pragma Import (C, pthread_rwlock_wrlock, "pthread_rwlock_wrlock");
   pragma Import (C, pthread_rwlock_wrlock, "pthread_mutex_lock");

   function pthread_rwlock_unlock (mutex : access pthread_rwlock_t)
                                  return int;
--  MaRTE
--   pragma Import (C, pthread_rwlock_unlock, "pthread_rwlock_unlock");
   pragma Import (C, pthread_rwlock_unlock, "pthread_mutex_unlock");
   ...
   --  << MaRTE OS
   PTHREAD_PRIO_NONE    : constant int;
   PTHREAD_PRIO_INHERIT : constant int;
   PTHREAD_PRIO_PROTECT : constant int;
   pragma Import (C, PTHREAD_PRIO_NONE,
                    "marte__kernel__mutexes__no_priority_inheritance");
   pragma Import (C, PTHREAD_PRIO_INHERIT,
                    "marte__kernel__mutexes__highest_blocked_task");
   pragma Import (C, PTHREAD_PRIO_PROTECT,
                    "marte__kernel__mutexes__highest_ceiling_priority");
   ...
   function pthread_mutex_setprioceiling_locked
     (mutex       : access pthread_mutex_t;
      prioceiling : int) return int;
   pragma Import (C, pthread_mutex_setprioceiling_locked,
   ...
   function pthread_create
     (thread        : access pthread_t;
      attributes    : access constant pthread_attr_t;  -- MaRTE OS: constant
   ...
   function pthread_attr_setreldeadline
     (attr         : access pthread_attr_t;
      rel_deadline : access constant timespec) return int;
   pragma Import (C, pthread_attr_setreldeadline,
                  "pthread_attr_setreldeadline");

   function pthread_attr_getreldeadline
     (attr         : access constant pthread_attr_t;
      rel_deadline : access timespec) return int;
   pragma Import (C, pthread_attr_getreldeadline,
                  "pthread_attr_getreldeadline");

   function pthread_attr_setpreemptionlevel
     (attr             : access pthread_attr_t;
      preemption_level : short) return int;
   pragma Import (C, pthread_attr_setpreemptionlevel,
                  "pthread_attr_setpreemptionlevel");

   function pthread_attr_getpreemptionlevel
     (attr             : access constant pthread_attr_t;
      preemption_level : access short) return int;
   pragma Import (C, pthread_attr_getpreemptionlevel,
                  "pthread_attr_getpreemptionlevel");

   function pthread_setdeadline (thread   : pthread_t;
                                 deadline : access constant timespec;
                                 clock_id : clockid_t;
                                 immediate : int)
                                 return int;
   pragma Import (C, pthread_setdeadline, "pthread_setdeadline");

   function pthread_getdeadline (thread   : pthread_t;
                                 clock_id : clockid_t;
                                 deadline : access timespec)
                                 return int;
   pragma Import (C, pthread_getdeadline, "pthread_getdeadline");

   function pthread_setpreemptionlevel
     (thread           : pthread_t;
      preemption_level : short) return int;
   pragma Import (C, pthread_setpreemptionlevel,
                  "pthread_setpreemptionlevel");

   function pthread_getpreemptionlevel
     (thread           : pthread_t;
      preemption_level : access short) return int;
   pragma Import (C, pthread_getpreemptionlevel,
                  "pthread_getpreemptionlevel");

   function marte_enable_rr_quantum (thread : pthread_t) return int;
   pragma Import (C, marte_enable_rr_quantum, "marte_enable_rr_quantum");

   function marte_disable_rr_quantum (thread : pthread_t) return int;
   pragma Import (C, marte_disable_rr_quantum, "marte_disable_rr_quantum");

   function pthread_mutexattr_setpreemptionlevel
     (attr        : access pthread_mutexattr_t;
      preemption_level : short) return int;
   pragma Import
     (C, pthread_mutexattr_setpreemptionlevel,
   ...
   function pthread_mutexattr_getpreemptionlevel
     (attr        : access pthread_mutexattr_t;
      preemption_level : access short) return int;
   pragma Import
     (C, pthread_mutexattr_getpreemptionlevel,
...
private
   ...
   CLOCK_REALTIME : constant clockid_t :=
     clockid_t (OS_Constants.CLOCK_REALTIME);
   --  MaRTE OS >>
...
--     type pid_t is new int;
   ...
   pragma Convention (C, pthread_key_t);  --  MaRTE OS
   PTHREAD_KEY_T_SIZE_IN_BYTES : constant Integer;  --  MaRTE OS
   pragma Import (C, PTHREAD_KEY_T_SIZE_IN_BYTES,  --  MaRTE OS
                  "PTHREAD_KEY_T_SIZE_IN_BYTES");

   --  No RW lock in MaRTE, mutex is used instead
   type pthread_rwlock_t is new pthread_mutex_t;  --  MaRTE OS
   type pthread_rwlockattr_t is new pthread_mutexattr_t;  --  MaRTE OS
