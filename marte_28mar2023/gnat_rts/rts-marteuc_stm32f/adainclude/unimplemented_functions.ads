package Unimplemented_Functions is
   ...
   --  Use Ada identifier rules for these two:
   procedure Gnat_Context_Switch_Needed;
   procedure Gnat_Alarm_Time;

   procedure S_task_prim_op_s;
   pragma Export (C, S_task_prim_op_s,
      "system__task_primitives__operations__self");

   procedure S_task_prim_op_in_tbc;
   pragma Export (C, S_task_prim_op_in_tbc,
      "system__task_primitives__operations__initialize_tcb");

   procedure S_task_prim_op_in_in;
   pragma Export (C, S_task_prim_op_in_in,
      "system__task_primitives__operations__initialize");

   procedure S_BB_SMCuC;
   pragma Export (C, S_BB_SMCuC,
      "system__bb__board_support__multiprocessors__current_cpu");

   procedure S_BB_CPCSTICS;
   pragma Export (C, S_BB_CPCSTICS,
   "system__bb__cpu_primitives__context_switch_trigger__" &
   "initialize_context_switch");

   procedure Interrupt_Stack_Table;
   pragma Export (C, Interrupt_Stack_Table, "interrupt_stack_table");

   procedure S_BB_CPCSTCS;
   pragma Export (C, S_BB_CPCSTCS,
   "system__bb__cpu_primitives__context_switch_trigger" &
   "__trigger_context_switch");

   procedure System_Bb_Threads_Queues_Running_Thread;
   pragma Export (C, System_Bb_Threads_Queues_Running_Thread,
      "system__bb__threads__queues__running_thread");

   procedure S_BB_ISCP;
   pragma Export (C, S_BB_ISCP,
      "system__bb__board_support__interrupts__set_current_priority");

   procedure System_Bb_Board_Support_Time_Read_Clock;
   pragma Export (C, System_Bb_Board_Support_Time_Read_Clock,
      "system__bb__board_support__time__read_clock");

   pragma Export (C, Gnat_Context_Switch_Needed,
      "__gnat_context_switch_needed");
   pragma Export (C, Gnat_Alarm_Time, "__gnat_alarm_time");
