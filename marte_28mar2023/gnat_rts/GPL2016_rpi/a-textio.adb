...
package body Ada.Text_IO is
   ...
   begin
      ...
      --  < MaRTE OS
      --  Standard_Err.Is_Regular_File
      --  := is_regular_file (fileno (stderr)) /= 0;
      Standard_Err.Is_Regular_File   := False;
      --  MaRTE OS >
      ...
      --  < MaRTE OS
      --  Standard_In.Is_Regular_File
      --  := is_regular_file (fileno (stdin)) /= 0;
      Standard_In.Is_Regular_File    := False;
      --  MaRTE OS >
      ...
      --  < MaRTE OS
      --  Standard_Out.Is_Regular_File
      --  := is_regular_file (fileno (stdout)) /= 0;
      Standard_Out.Is_Regular_File   := False;
      --  MaRTE OS >
