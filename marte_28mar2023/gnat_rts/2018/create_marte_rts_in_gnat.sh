...
# GNAT PATH
GNAT_PATH="/home/mario/opt/GNAT/2018-arm-elf"
readonly GNAT_PATH
printf "\nGNAT 2018 in dir: $GNAT_PATH\n\n"

if [ ! -e ${GNAT_PATH}/arm-eabi/BSPs/cortex-m/armv7-m/stm32/stm32f4/marte/ ]; then
   printf "\nCreating ${GNAT_PATH}/arm-eabi/BSPs/cortex-m/armv7-m/stm32/stm32f4/marte/ directory\n"
   cd ${GNAT_PATH}/arm-eabi/BSPs/cortex-m/armv7-m/stm32/stm32f4
   mkdir marte/
   cp -r ravenscar-full/* marte/
   cd marte
   rm -f adalib/* obj/*
fi
printf "\nFalta modificar ${GNAT_PATH}/arm-eabi/BSPs/cortex-m/armv7-m/stm32/stm32f4/marte/ada_source_path\n"
