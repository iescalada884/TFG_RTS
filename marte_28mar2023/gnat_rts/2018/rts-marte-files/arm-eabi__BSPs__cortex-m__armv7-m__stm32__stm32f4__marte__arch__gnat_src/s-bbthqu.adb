...
package body System.BB.Threads.Queues is
   ...
   -----------------------------------
   -- Environment_Thread (MaRTE OS) --
   -----------------------------------

   Environment_Thread : Thread_Id := null;  --  MaRTE OS

   --  Used to store the Environment_Thread (the only Thread_Id created
   --  in MaRTE OS). It is returned by Running_Thread.
   ...
   begin
      ...
      if Thread = Environment_Thread then
         return;  -- This is always true in MaRTE OS
      end if;
...
--        return First_Thread /= Running_Thread;  MaRTE OS
      return  First_Thread_Table (Current_CPU) /=
        Running_Thread_Table (Current_CPU);  --  MaRTE OS
   ...
   begin
      if Environment_Thread = null then  --  MaRTE OS

         --  Register the environment thread.

         Environment_Thread := Thread;  --  MaRTE OS
      end if;
   ...
   begin
      pragma Assert (False); -- Not used in MaRTE OS
...
--        return Running_Thread_Table (Current_CPU);
      return Environment_Thread;  --  MaRTE OS
   end Running_Thread;
