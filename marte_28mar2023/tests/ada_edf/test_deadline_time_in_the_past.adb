...
--                                                             V2.0 2019-05-24
--
--         'T e s t _ D e a d l i n e _ T i m e _ I n _ T h e _ P a s t'
--
--                               Ada Program
--
--
--  File 'test_deadline_time_in_the_past.adb'                        By MAR.
--
--  Tests a task with a deadline in the past is the most urgent.
--
--  ----------------------------------------------------------------------
...
procedure Test_Deadline_Time_In_The_Past is
...
begin
   Reports.Init;
   TIO.Put_Line ("Test_Delay_And_Set_Deadline_Past_Time ");
...
end Test_Deadline_Time_In_The_Past;
