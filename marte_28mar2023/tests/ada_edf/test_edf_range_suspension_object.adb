...
--                                                             V2.0 2019-05-24
--
--      'T e s t _ E D F _ R a n g e _ S u s p e n s i o n _ O b j e c t '
--
--                               Ada Program
--
--
--  File 'test_edf_range_suspension_object.adb'                      By MAR.
--
--  Tests operation 
--  Ada.Synchronous_Task_Control.EDF.Suspend_Until_True_And_Set_Deadline and
--  checks the new deadline was set OK.
--  Uses priority specific dispatching.
--
--  ----------------------------------------------------------------------
...
--
------------------------------------------------------------------------------
pragma Priority_Specific_Dispatching (EDF_Across_Priorities, 1, 5);
...
procedure Test_EDF_Range_Suspension_Object is
   ...
   begin
      ...
      --  Suspend to be activated with long deadline
   ...
   task body EDF_Task_2 is
   begin
      Reports.Assert (Step_Counter = 2);
      Step_Counter := Step_Counter + 1;
      
      Put_Line ("EDF_Task_2 before Suspend_Until_True");
      --  Suspend to be activated with short deadline
      STC.EDF.Suspend_Until_True_And_Set_Deadline (Susp_Object_2,
						   Deadline_Short);    
      Put_Line ("EDF_Task_2 after Suspend_Until_True");
...
end Test_EDF_Range_Suspension_Object;
