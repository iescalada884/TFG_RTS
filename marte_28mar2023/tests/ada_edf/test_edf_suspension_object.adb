...
--                                                             V2.0 2019-05-24
--
--            'T e s t _ E D F _ S u s p e n s i o n _ O b j e c t '
--
--                               Ada Program
--
--
...
procedure Test_EDF_Suspension_Object is
   ...
   Deadline_Very_Short : constant RT.Time_Span := RT.To_Time_Span (10.0);
   ...
   pragma Relative_Deadline (Deadline_Very_Short);
...
begin
   ...
   Reports.Test_OK; 
end Test_EDF_Suspension_Object;
