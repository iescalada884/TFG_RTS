...
--                                                             V2.0 2019-05-24
--
--                       'T e s t _ E D F _ P O _ E n t r y'
--
--                               Ada Program
--
--
...
--
--  Tests PO entries works with EDF.
--
--  ----------------------------------------------------------------------
...
procedure Test_EDF_PO_Entry is
   ...
   protected PO is
      pragma Priority (Task_D_Past_Prio + 1);  -- higher prio in the system
      entry Wait;
      procedure Go;
   private
      Start : Boolean := False;
   ...
   begin
      ...
      TIO.Put_Line ("EDF_Task loop BEFORE entry");
      PO.Wait;   
      TIO.Put_Line ("EDF_Task loop AFTER entry");
...
begin
   Reports.Init;
   TIO.Put_Line ("Test_EDF_PO_Entry ");
   ...
   TIO.Put_Line ("Main before open entry");
   PO.Go;
