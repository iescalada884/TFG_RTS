...
--                                                             V2.0 2019-05-24
--
--                'T e s t _ G e t _ I m m e d i a t e _ 2'
--
--                               Ada Program
--
--
...
--
--  Test if Get_Immedidate(Character, Boolean) blocks only one task or the
--  whole application.
--
--  ----------------------------------------------------------------------
...
procedure Test_Get_Immediate_2 is
   ...
   After_Get_Immediate_Finishes : Boolean := False;
   pragma Volatile (After_Get_Immediate_Finishes);
   ...
   begin
      ...
      --  Finish immediately without returning any char

      Reports.Assert (not Available);

      After_Get_Immediate_Finishes := True;
