...
--  protected operation
--
--  Quantum or execution load doesn't works well. Yielding (delay 0.0) CPU
--  instead of "eating" CPU time to force quantum expiration. See
--  Test_Round_Robin_PO_Fails
--
------------------------------------------------------------------------------
...
procedure Test_Round_Robin_PO is
...
begin
   Reports.Init;
   Put_Line ("Test_Round_Robin_PO abc");
