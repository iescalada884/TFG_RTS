...
--
--
--  File 'posix-signals-implementation.ads'                            By MAR.
--
...
package POSIX.Signals.Implementation is

   Null_Signal_Set : constant Signal_Set;

   function Get_MSignal_Set_Ref (Set : in Signal_Set)
                                 return MaRTE.Kernel.Signals.Signal_Set_Ac_Const;

private
   Null_Signal_Set : constant Signal_Set := (C => MaRTE.Kernel.Signals.Empty_Set);
