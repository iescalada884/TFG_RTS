...
--                                                             V2.0 2019-05-24
--
--                   'T e x t _ C o n s o l e _ I m p o r t'
--
--                                    Spec
--
--
--  File 'text_console_import.ads'               By MAR and
--                                                  Miguel Ángel Masmano Tello.
--
--  MaRTE OS on Linux.
--
--  Import the functions of the Console driver (just a wrapper to
--  'linux_write' and 'linux_read' system calls).
--
--  ----------------------------------------------------------------------
...
package Text_Console_Import is
   ...
   pragma Import (C, Remove, "text_console_remove");
   ...
   pragma Import (C, Open, "text_console_open");
   ...
   pragma Import (C, Close, "text_console_close");
   ...
   pragma Import (C, Read, "text_console_read");
