...
#endif // #ifndef __NR_timer_create
...
#define proc_syscall1(type,name,type1,arg1) \
type linux_##name(type1 arg1) \
{ \
     unsigned int retval; \
     retval = INLINE_SYSCALL( name, 1, arg1); \
}
...
type linux_##name (type1 arg1, type2 arg2, type3 arg3, type4 arg4) \
{ \
