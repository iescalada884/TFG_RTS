...
extern int linux_timer_create(clockid_t which_clock, 
                        struct sigevent *timer_event_spec,
                        timer_t *created_timer_id) __THROW;

extern int linux_timer_gettime(timer_t timer_id, struct itimerspec *setting) __THROW;

extern int linux_timer_settime(timer_t timer_id,
                         int flags,
                         const struct itimerspec *new_setting,
                         struct itimerspec *old_setting) __THROW;

extern int linux_timer_getoverrun(timer_t timer_id) __THROW;

extern int linux_timer_delete(timer_t timer_id) __THROW;

extern int linux_clock_gettime(clockid_t which_clock, struct timespec *ts) __THROW;

extern int linux_clock_settime(clockid_t which_clock, 
                         const struct timespec *setting) __THROW;

extern int linux_clock_getres(clockid_t which_clock, 
                        struct timespec *resolution) __THROW;

extern int linux_clock_nanosleep(clockid_t which_clock,
                    int flags,
