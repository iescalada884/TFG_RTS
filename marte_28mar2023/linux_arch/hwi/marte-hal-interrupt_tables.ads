...
--
--
--  File 'interrupt_tables.ads'                  By Miguel Ángel Masmano Tello
--                                                  and MAR.
--
--
...
package MaRTE.HAL.Interrupt_Tables is
   ...
   ------------------------------------
   function Linux_Signals_Get_Timer_Signal return HW_Interrupt;
   pragma Import (C, Linux_Signals_Get_Timer_Signal,
                    "linux_signals_get_timer_signal");
