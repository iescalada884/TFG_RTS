...
--
--  Linux Library version of this file.
--
...
package MaRTE.Kernel.File_System is
   ...
   function Open
      ...
      return Int;
   pragma Export (C, Open, "marte_open");  --  Linux Lib change
   ...
   function Close (Fd : in File_Descriptor)
                  return Int;
   pragma Export (C, Close, "marte_close");  --  Linux Lib change
   ...
   function Read
      ...
      return Int;
   pragma Export (C, Read, "marte_read");  --  Linux Lib change
   ...
   function Write
     ...
     return Int;
   pragma Export (C, Write, "marte_write");  --  Linux Lib change
   ...
   pragma Export (C, Ungetc, "marte_ungetc_fd");  --  Linux Lib change
   ...
   function Ioctl
     ...
     return Int;
   pragma Export (C, Ioctl, "marte_ioctl");  --  Linux Lib change
