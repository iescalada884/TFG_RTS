 ...
 *
 * Defines the 'main' function of an Ada program for the "Linux Library"
 * architecture. It calls 'marte_init()' in order to elaborate the Ada
 * part of the kernel before calling the user's main function.
 *
 * At linking time is included either this file or 'wrapper_main_c.o'
...
extern void marte_init();  // ada packages initialization
extern void marte_final(); // ada packages finalization
...
int main(int argc, char *argv[], char *envp[])
{
  ...
  marte_init(); // Call elaboration of ada packages

  ret = user_main(argc, argv, envp); // call user's Ada main procedure
