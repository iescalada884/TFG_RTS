...
extern void marte_init();
// Elaboration of MaRTE Ada packages

extern void marte__hal__install_hw_interrupt_handler (int irqnr, void *handler (int irqnr));
extern int marte__hal__timer_interrupt ();
extern void timer_interrupt_handler (int irqnr);
extern void marte__hal__hardware_interrupt_controller_enable_interrupt (int irqnr);
...
void marte_init_remaining_vcpus () {
    ...
    marte__hal__hardware_interrupt_controller_enable_interrupt (marte__hal__timer_interrupt());
}
