...
--
--  MaRTE on XtratuM vesion of this package.
--
...
package MaRTE.Kernel.Devices_Table is
   ...
   The_Driver_Table :  K.File_System_Data_Types.Driver_Table_Type :=
     (
      ...
      1 => (Name   => "None            ",
            Create => Text_Console_Import.Create_Ac,
            Remove => null,
            Open   => null,
            Close  => null,
            Read   => Text_Console_Import.Read_Ac,
            Write  => null,
            Ioctl  => Text_Console_Import.Ioctl_Ac,
            Delete => null,
            Lseek  => null),
      ...
      2 => (Name   => "Console         ",
            Create => Text_Console_Import.Create_Ac,
            Remove => Text_Console_Import.Remove_Ac,
            Open   => Text_Console_Import.Open_Ac,
            Close  => Text_Console_Import.Close_Ac,
            Read   => null,
            Write  => Text_Console_Import.Write_Ac,
            Ioctl  => Text_Console_Import.Ioctl_Ac,
            Delete => null,
            Lseek  => null),
      --  2 => (Name   => "Text Console    ",
