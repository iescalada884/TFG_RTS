...
--
--  MaRTE on XtratuM version of this package.
--
...
private
   ...
   function Stdout_Basic_Init return MaRTE.Integer_Types.Int;
   pragma Import (C, Stdout_Basic_Init, "text_console_create");
   ...
   pragma Import (C, Stderr_Basic_Init, "text_console_create");
   ...
   function Stderr_Direct_Write (Fd         : in MaRTE.Integer_Types.Int;
                                 ...
                                 Bytes      : in MaRTE.Integer_Types.Size_T)
                                return MaRTE.Integer_Types.Ssize_T;
   pragma Import (C, Stderr_Direct_Write, "text_console_write");
   ...
   --          renames Null_Read;
   function Stdin_Direct_Read return MaRTE.Integer_Types.Unsigned_8;
   pragma Import (C, Stdin_Direct_Read, "text_console_read");
