...
#define MARTE_ARCHITECTURE   ARCH_XTRATUM      

// Main task's stack size (only used in x86 architecture)
#define _MARTE_CONFIG_MAIN_TASK_STACK_SIZE_IN_BYTES       65536

// Dinamic Memory
//extern char dynamic_memory_pool[]; <--- remove??
#define DYNAMIC_MEMORY_POOL_SIZE_IN_K           (1*1024)
...
#define DEVICES_FILES_MX          20
#define DEVICES_MX                16
