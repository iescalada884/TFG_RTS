...
private
   ...
   function Stdout_Basic_Init return MaRTE.Integer_Types.Int
     renames Null_Init;
   --  function Stdout_Basic_Init return MaRTE.Integer_Types.Int;
   --  pragma Import (C, Stdout_Basic_Init, "hdmi_console_init");
   ...
   --               "hdmi_console_end_of_kernel_initialization");

   function Stderr_Basic_Init return MaRTE.Integer_Types.Int
     renames Null_Init;
   --  function Stderr_Basic_Init return MaRTE.Integer_Types.Int;
   --  pragma Import (C, Stderr_Basic_Init, "hdmi_console_init");
   ...
   function Stdout_Direct_Write (Fd         : in MaRTE.Integer_Types.Int;
                                 ...
                                 Bytes      : in MaRTE.Integer_Types.Size_T)
                                return MaRTE.Integer_Types.Ssize_T;
   --  pragma Import (C, Stdout_Direct_Write, "hdmi_console_putDirect");
   pragma Import (C, Stdout_Direct_Write, "uart_simple_write");

   function Stderr_Direct_Write (Fd         : in MaRTE.Integer_Types.Int;
                                 Buffer_Ptr : in System.Address;
                                 Bytes      : in MaRTE.Integer_Types.Size_T)
                                return MaRTE.Integer_Types.Ssize_T;
   --  pragma Import (C, Stderr_Direct_Write, "hdmi_console_putDirect");
   pragma Import (C, Stderr_Direct_Write, "uart_simple_write");
