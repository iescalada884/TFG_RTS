...
--                                                             V2.0 2019-05-24
--
--                  'U A R T _ S i m p l e _ I m p o r t'
--
--                                    Spec
--
--
--  File 'uart_simple_import.ads'                                  By MAR
--
--
--  Import the functions of "uart_simple.c"
--
--
--  ----------------------------------------------------------------------
...
package UART_Simple_Import is

   --  Create
   function Create return Int;
   pragma Import (C, Create, "uart_simple_create");
   ...
   pragma Import (C, Write, "uart_simple_write");
   ...
   --  Ioctl
   Ioctl_Ac : Ioctl_Function_Ac := null;

end UART_Simple_Import;
