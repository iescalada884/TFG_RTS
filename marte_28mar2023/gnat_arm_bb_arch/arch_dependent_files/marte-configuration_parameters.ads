...
--
--
--  This is the GNAT BB ARM architecture version of this package.
--
--
--
...
package MaRTE.Configuration_Parameters is
   ...
   subtype MaRTE_Architecture is Supported_Architectures
     range ARCH_GNAT_BB_ARM .. ARCH_GNAT_BB_ARM; --  DO NOT EDIT !!
   ...
   Main_Stack_Size_In_Bytes : constant := 16#8000# - 16#300#;
   --  0x8000 - 0x300 = 32000B (see rpi_arch/marte_rpi.ld)
   --  Size of the main task's stack
   ...
   subtype Measure_Interrupt_Handlers_Time is Boolean range False .. False;
   --  When this parameter is true execution time consumed by the
