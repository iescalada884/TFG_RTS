...
enum {
    ...
    for(x=0;x<8;x++){
        for(y=0;y<8;y++){
            ////////////////////
            if((piece=board[(abs(x))*8+(abs(y-7))])>0){
                if(piece<7){//white pieces
...
void initVGA(){
    ...
    piecesImages[0]=king_img;
    piecesImages[1]=queen_img;
    piecesImages[2]=rook_img;
    piecesImages[3]=bishop_img;
    piecesImages[4]=knight_img;
    piecesImages[5]=pawn_img;
