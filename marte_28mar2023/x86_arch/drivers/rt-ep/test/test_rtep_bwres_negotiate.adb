...
procedure Test_RTEP_BWRES_Negotiate is
...
begin
   ...
   if RP.Get_Station_ID = 1 then

      for I in 1 .. 100000 loop
         Ada.Text_Io.Put_Line ("Sending info..."&Integer'Image (I));
         RP.Send_Info
