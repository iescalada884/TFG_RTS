...
procedure test_rtep_server_multicast_measurement is
   ...
   procedure Job_1 is
      ...
      Dest_Station_ID : RTEP.Station_ID := RP.Get_Station_ID_By_Name ("slaves");
   ...
   procedure Job_2 is
      --  Receiving variables
      Source_Station_ID : RTEP.Station_ID;
      Dest_Station_ID : RTEP.Station_ID := RP.Get_Station_ID_By_Name ("broadcast");
      Rx_Info : Ada.Streams.Stream_Element_Array (1 .. RTEP.Max_RTEP_MTU);
      Rx_Info_Last: Ada.Streams.Stream_Element_Offset;
      Rx_Priority : RTEP.Priority;
      --  Sending variables
...
end test_rtep_server_multicast_measurement;
