...
package body Var_Strings is
   ...
   begin
      if V1.Num + V2.Num > Max_Length then
         ...
         Res.Str (1 .. V1.Num + V2.Num) := V1.Str (1 .. V1.Num) &
           V2.Str (1 .. V2.Num);
   ...
   begin
      return V1.Num = V2.Num and then V1.Str (1 .. V1.Num) =
        V2.Str (1 .. V2.Num);
   end "=";
   ...
   begin
      Res.Num := V.Num;
      Res.Str (1 .. Res.Num) :=
        Characters.Handling.To_Upper (V.Str (1 .. V.Num));
      return Res;
   end To_Upper;
   ...
   begin
      Res.Num := V.Num;
      Res.Str (1 .. Res.Num) :=
        Characters.Handling.To_Lower (V.Str (1 .. V.Num));
      return Res;
   end To_Lower;
