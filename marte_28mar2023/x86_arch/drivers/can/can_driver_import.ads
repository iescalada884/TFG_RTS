...
--
--
--  File 'can_driver_import.ads'                          By JLC and Sangorrin
--
--
--  Import the driver functions from can_driver.h to install the driver in
--  MaRTE OS filesystem.
--
--  ----------------------------------------------------------------------
...
package CAN_Driver_Import is

   --  Create
   function Create (Create_Arg : in Int) return Int;
   pragma Import (C, Create, "can_driver_create");
   ...
   pragma Import (C, Remove, "can_driver_remove");
   ...
   pragma Import (C, Open, "can_driver_open");
   ...
   pragma Import (C, Close, "can_driver_close");
   ...
   pragma Import (C, Read, "can_driver_read");
   ...
   function Write (Fd         : in File_Descriptor;
                   Buffer_Ptr : in Buffer_Ac;
                   Bytes      : in Buffer_Length) return Int;
   pragma Import (C, Write, "can_driver_write");
   ...
   pragma Import (C, Ioctl, "can_driver_ioctl");
