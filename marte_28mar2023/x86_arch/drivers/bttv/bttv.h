...
extern int bttv_get_cardinfo(unsigned int card, int *type,
			     unsigned int *cardid);
extern struct pci_device* bttv_get_pcidev(unsigned int card);
...
/*MaRTE OS*/
extern int bttv_init(void);
extern int bttv_open(int num);
extern int bttv_ioctl(int num,unsigned int cmd, void * arg);
extern void bttv_close(void);
