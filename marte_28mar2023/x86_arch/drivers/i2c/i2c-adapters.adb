...
--                                    body
--
-- File 'i2c-adapters.adb'                                    By Sangorrin
--
--
-- An adapter represents a physical i2c bus, and how to send/receive bytes
...
package body I2c.Adapters is

   function Get_Id (
         Adap : I2c_Adapter)
     return I2c_Adapter_Id is
   begin
      return Adap.Id;
   end Get_Id;
