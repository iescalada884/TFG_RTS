...
#ifdef DEBUG
  printf("neo_setdisplaystart: 0x%x\n", address);
#endif
  address=address >> 2;
...
static int neo_init(int force, int par1, int par2)
{
	...
	printf("Using NeoMagic driver, %iKB.\n",neo_memory);
    };
