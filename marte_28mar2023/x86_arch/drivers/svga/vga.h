...
*/
/*<MaRTE OS*/
/*#define conversor_32_a_16(rgb) ( ( (WORD)(rgb & 0xF8)>>3) | ( (WORD) ((rgb>>5)& 0x7E0) ) | ((WORD)((rgb>>8) & 0xF800)))
#define conversor_24_a_16(rgb) ( ( (WORD)(rgb & 0xF8)>>3) | ( (WORD) ((rgb>>5)& 0x7E0) ) | ((WORD)((rgb>>8) & 0xF800)))
#define conversor_32_a_15(rgb) ( ( (WORD)(rgb & 0xF8)>>3) | ( (WORD) ((rgb>>5)& 0x3E0) ) | ((WORD)((rgb>>9) & 0x7C00)))
#define conversor_24_a_15(rgb) ( ( (WORD)(rgb & 0xF8)>>3) | ( (WORD) ((rgb>>5)& 0x3E) ) | ((WORD)((rgb>>9) & 0x7C00)))*/
/*MaRTE OS>*/
...
//    extern int vga_hasmode(int mode);	/*MaRTE OS*/
...
/*MaRTE OS*/
/*Empleado para el mapeo de la memoria RAM a la de video*/
