...
------------------------------------------------------------------------------
--
--                          'e t h e r n e t . a d s'
--
--                                     C
--
--
--  File 'ethernet.ads'                                               By Chema.
--                                                          Jose Maria Martinez
--                                                            <chema@gmx.net>
--  Import functions of ethernet.h
--
-----------------------------------------------------------------------------
...
package Ethernet is
   ...
   pragma Import (C, Create, "eth_create");
   ...
   pragma Import (C, Close, "eth_close");
   ...
   function Write (Fd         : in File_Descriptor;
                   Buffer_Ptr : in Buffer_Ac;
                   Bytes      : in Buffer_Length) return Int;
   pragma Import (C, Write, "eth_write");
   ...
   pragma Import (C, Ioctl, "eth_ioctl");
