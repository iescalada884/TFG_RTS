...
--                                                             V2.0 2019-05-24
--
--                       'M a R T E . D i r e c t _ I O'
--
--                                   Spec
--
--
--  File 'marte-direct_io.ads'                                        By MAR.
--
...
package MaRTE.Direct_IO is
   ...
   procedure Put (N : in Integer_8; Base : in Positive := 10);

   procedure Put (N : in Integer_32; Base : in Positive := 10);

   procedure Put (N : in Unsigned_8; Base : in Positive := 10);

   procedure Put (N : in Unsigned_32; Base : in Positive := 10);

   procedure Put (N : in Unsigned_64; Base : in Positive := 10);

   procedure Put (N : in System.Address; Base : in Positive := 16);
...
private
...
#if MARTE_BOARD = "stm32f4" then
   function Stdout_Basic_Init return MaRTE.Integer_Types.Int
     renames Null_Init;

#elsif MARTE_BOARD = "stm32f769disco" then
   function Stdout_Basic_Init return MaRTE.Integer_Types.Int;
   pragma Import (C, Stdout_Basic_Init, "lcd_create");
#end if;

#if MARTE_BOARD = "stm32f4" then
   procedure Stdout_End_Of_Kernel_Initialization
     renames Null_End_Of_Kernel_Initialization;
   ...
   function Stderr_Basic_Init return MaRTE.Integer_Types.Int
     renames Null_Init;
   --  function Stderr_Basic_Init return MaRTE.Integer_Types.Int;
   --  pragma Import (C, Stderr_Basic_Init, "xxx_init");
...
#if MARTE_BOARD = "stm32f4" then
   pragma Import (C, Stdout_Direct_Write, "gnat_io_driver_functions__write");
   pragma Import (C, Stderr_Direct_Write, "gnat_io_driver_functions__write");

#elsif MARTE_BOARD = "stm32f769disco" then
   pragma Import (C, Stdout_Direct_Write, "lcd_write");
   pragma Import (C, Stderr_Direct_Write, "lcd_write");
#end if;
   ...
   function Stdin_Direct_Read return MaRTE.Integer_Types.Unsigned_8
     renames Null_Read;
   --  function Stdin_Direct_Read return MaRTE.Integer_Types.Unsigned_8;
   --  pragma Import (C, Stdin_Direct_Read, "hdmi_console_read");
