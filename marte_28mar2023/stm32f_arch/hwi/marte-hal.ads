...
package MaRTE.HAL is
   ...
   package BBParam renames System.BB.Parameters;
   ...
   -- Interrupts --------------------------------------------------------------
   ----------------------------------------------------------------------------
   subtype HW_Interrupt is BBParam.Interrupt_Range;
   
   PendSV_Vector : constant HW_Interrupt := 14;
...
--   pragma Convention (C, Default_HW_Interrupt_Handler); -- Necesario para ARM?
   ...
   type Context_Id is range 0 .. BBParam.Context_Buffer_Capacity - 1;
...
private
   Context_Buffer_Size : constant :=
     BBParam.Context_Buffer_Capacity * System.Word_Size;
