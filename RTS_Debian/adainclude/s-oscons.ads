...
package System.OS_Constants is
   ...
   SO_SNDTIMEO                   : constant := 67;         --  Emission timeout
   SO_RCVTIMEO                   : constant := 66;         --  Reception timeout
   ...
   SIZEOF_tv_nsec                : constant := 4;          --  tv_nsec
   ...
   Glibc_Use_Time_Bits64         : constant Boolean := True;       --  Y2038 Glibc transition
